...
## TL;DR
deserialization of a field with `@JsonUnwrapped` reliably works for mutable classes that have **setter** and a **no args constructor**
...
```
Unfortunately this fails in `2.8.10` and `2.11.1`.

## mutable fields with setter and no (args) constructor
see [Unwrapping3.java](src/main/java/com/mercateo/Unwrapping2.java), setter and getter are generated by [Lombok](https://projectlombok.org/)
```java
class Unwrapping3 {
    @Getter
    @Setter
